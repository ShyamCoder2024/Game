        ...
        <header className="sticky top-0 z-30 bg-white border-b border-gray-200 shadow-sm px-4 py-3 lg:px-6 lg:h-16 flex flex-col lg:flex-row lg:items-center justify-between gap-3">
            <div className="flex items-center justify-between w-full lg:w-auto">
                ...
                <div className="flex items-center gap-2 lg:hidden">
                    <div className="flex items-center gap-1.5 bg-[#0891B2]/10 text-[#0891B2] rounded-full px-2.5 py-1 text-xs font-bold whitespace-nowrap">
                        <Wallet size={12} />
            ...
            <div className="hidden lg:flex items-center gap-3">
                ...
                <Badge className="text-xs text-white px-3 py-0.5" style={{ backgroundColor: '#0891B2' }}>Master</Badge>
